 ...
 * argued: the engine's stack is 2 KB at $2E38-$3637 and the gates find
 * 1,239 bytes of it used at the low-water mark, with 47 bytes free in
 * LoRAM.  There is no room in bank $00 for a second one.
 *
